...
Getting Started
---------------
* To find out how to use Tarcel go to the [Tarcel project page](http://vlifesystems.com/projects/tarcel/).
* Take a look at the [tarcel.tarcel](https://github.com/LawrenceWoodman/tarcel/blob/master/tarcel.tarcel) file used to package Tarcel.
* Look in the _doc/_ directory of the repo.
